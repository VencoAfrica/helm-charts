...
%prun -T "/home/frappe/perf.txt" -s cumulative _new_site(None, "demochude.venco.africa", "root","root-password","admin",False, ["erpnext","estate_manager","mpesa_integration","meter_management","simple_payments","control_central_client"], None, True,True, False, "root-password", "mariadb", "frappe-bench-erpnext-mariadb","3306",True)